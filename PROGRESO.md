...
- dataset: índice compacto o SQLite FTS5 (decidido)
- Next: Paso 2 — persistir spec maestro con Kiro# PROGRESO
...
- Próximo: Cierre del Paso 1 (4 ítems manuales), luego Paso 2 (spec maestro)# PROGRESO

Spec actual: personal-stock-mvp-master (spec maestro)
Tarea actual: —
